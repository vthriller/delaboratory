...
class deCurvesEditor:public deActionFrame
{
    ...
    public:
        deCurvesEditor(wxWindow *parent, deLayerWithBlending& _layer, deLayerProcessor& _layerProcessor, deLayerFrameManager& _frameManager, int _layerIndex, deChannelManager& _channelManager);

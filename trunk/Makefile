...
FILES = delaboratory project main_frame image_io layer_grid_panel image_area_panel image_panel renderer curves_panel frame slider histogram_panel control_panel gradient_panel view_mode_panel help_frame help_color_spaces_frame help_color_spaces_frame2 layer_frame help_color_spaces_frame3 help_color_spaces_frame4 help_color_spaces_frame5 skin_color_chart help_color_spaces_frame6 xml histogram_mode_panel file_dialogs layer_processor external_editor choice property_choice_ui check_box property_boolean_ui samplers_panel sampler_panel layer_frame_manager rendered_image dcraw_support raw_module zoom_panel threads_panel palette color_matrix_frame color_matrix mutex color_space_utils semaphore main_window canvas canvas_wx bitmap bitmap_wx switchable_layer layer_with_blending window window_wx panel_wx property_numeric_ui preset_button button warning_panel generic_layer_frame films property_levels_ui mutex_read_write test_image property_mixer_ui palette_frame channel_selector property_curves_ui tiff logger str_wx update_main_layer_image layer_processor_threads
...
${APP}: ${CORE_OBJECTS} ${OBJECTS} ${LAYERS_OBJECTS} ${ALGORITHMS_OBJECTS} ${PROPERTIES_OBJECTS}

...
deAutoDodgeLayer::deAutoDodgeLayer(deColorSpace _colorSpace, deChannelManager& _channelManager, int _sourceLayer, deLayerStack& _layerStack, deViewManager& _viewManager)
...
deAutoDodgeLayer::~deAutoDodgeLayer()
{
}
...
//    mainLayerImage.enableChannel(channel);
    ...
    {
        result = autoDodgeBurn(source, destination, size, r1, r2, t, false);
    }        
